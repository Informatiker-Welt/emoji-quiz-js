...
const initializeQuiz = () => {
  ...
  if (quizArray.length === 0) {
    ...
    <li class="emoji">🤓</li>
    <li class="emoji">🤙</li>`;
    inputLabel.innerHTML = "Das ist alles, Leute! Danke fürs Spielen";
    btnSkip.remove();
    stopTimer();
  }
};
...
const updateScore = () => {
  totalScore.innerHTML = `<li class='success'> Richtig: <span>${currentScore}</span></li>
  <li class='fail'>Fehlgeschlagen: <span>${currentFailed}</span></li>
  <li class='total'>Verbleibende Zeit: <span>${
